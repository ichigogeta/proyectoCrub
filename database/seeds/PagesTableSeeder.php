    ...
    public function run()
    {
        ...
        if (!$page->exists) {
            $page->fill([
                ...
                'excerpt' => 'Entradilla sobre nosotros',
                'body' => '<p>Esto es una prueba del contenido que podrás añadir desde tu panel de administración.</p>',
                'meta_description' => 'sobre nosotros',
                'meta_keywords' => 'sobre, nosotros',
                'status' => 'ACTIVE',
            ])->save();
        }

        $page = Page::firstOrNew([
            'slug' => 'aviso-legal-y-cookies',
        ]);

        if (!$page->exists) {
            $page->fill([
                'author_id' => 0,
                'title' => 'Aviso Legal y uso de cookies',
                'excerpt' => '.',
                'body' => '<p>.</p>',
                'meta_description' => 'Aviso Legal y uso de cookies',
                'meta_keywords' => 'aviso, legal, cookies',
                'status' => 'ACTIVE',
            ])->save();
        }
        ...
        if (!$page->exists) {
            $page->fill([
                ...
                'excerpt' => '.',
                'body' => '<p>.</p>',
                'meta_description' => 'Política de Privacidad',
                'meta_keywords' => 'politica, privacidad',
                'status' => 'ACTIVE',
            ])->save();
        }
